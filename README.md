...
# Matplotlib Bootcamp Assignment -  The Power of Plots

What good is data without a good plot to tell the story?

In this assignment, I had to apply what I learned about Matplotlib to a real-world situation and dataset.
...
Create two summary statistics DataFrames:
    ...
    * For the first table, use the `groupby` method to generate the mean, median, variance, standard deviation, and SEM of the tumor volume for each drug regimen. This resulted in five unique series objects, then combine these objects into a single summary statistics DataFrames.
...
1. Generate two bar plots. Both plots were identical and show the total number of timepoints for all mice tested for each drug regimen throughout the course of the study.

    * Create the first bar plot by using Pandas's `DataFrame.plot()` method.

    * Create the second bar plot by using Matplotlib's `pyplot` methods.

2. Generate two pie plots. Both plots were identical and show the distribution of female or male mice in the study.
...
Review all the figures and tables generated in this assignment. 
